...
\begin{document}
  ...
  \label{sec:code}
    ...
    \begin{listing}[H]
      \centering
      \inputminted{SAS}{./res/code/predict.r}
      \caption{Cálculo de la predicción utilizando el lenguaje \texttt{R} de las $24$ observaciones siguientes utilizando el modelo $\text{SARIMA}(0, 1, 1)(0, 1, 1)_{12}(0, 0, 1)_{17}$ sobre la serie \texttt{weightloss}.}
      \label{code:predict_r}
    \end{listing}
