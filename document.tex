...
\begin{document}
  ...
  \label{sec:fitting}
    ...
    \label{sec:fitting_1}
      ...
      \begin{table}[htb!]
        \centering
        \includegraphics[width=0.35\textwidth]{validation-1-metrics}
        \caption{[TODO].}
        \label{}
      \end{table}
    ...
    \label{sec:fitting_1}
      ...
      \begin{table}[htb!]
        \centering
        \includegraphics[width=0.35\textwidth]{validation-2-metrics}
        \caption{[TODO].}
        \label{}
      \end{table}
    ...
    \label{sec:fitting_3}
      ...
      \begin{table}[htb!]
        \centering
        \includegraphics[width=0.35\textwidth]{validation-3-metrics}
        \caption{[TODO].}
        \label{}
      \end{table}
    ...
    \label{sec:fitting_4}
      ...
      \begin{table}[htb!]
        \centering
        \includegraphics[width=0.35\textwidth]{validation-4-metrics}
        \caption{[TODO].}
        \label{}
      \end{table}
  ...
  \label{sec:code}
    ...
    \begin{listing}[H]
      \centering
      \inputminted{SAS}{./res/code/validation.sas}
      \caption{[TODO]}
      \label{}
    \end{listing}
